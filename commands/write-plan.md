...
1. Verifier que le brainstorming est fait
2. Creer le plan avec taches specifiques
3. Definir les validations pour chaque tache
4. Obtenir approbation avant `/execute-plan`
