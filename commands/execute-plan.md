...
1. Charger les taches dans TodoWrite
2. Executer chaque tache avec validation
3. Generer les livrables (Python/.py, DAX/.md, Excel/.md, SQL/.sql)
4. Checkpoint final avec resume des outputs
